...
class StringTestSuite {
    ...
    Test_WordWrap() {
        DUnit.Throws(_String.WordWrap.Bind("abc", "a"), "TypeError")
    ...
    Test_DeleteLine() {
        DUnit.Throws(_String.DeleteLine.Bind("abc", 0, "a"), "ValueError")
        DUnit.Equal("aaa|bbb|777|ccc".DeleteLine(3, "|"), "aaa|bbb|ccc")
        DUnit.Equal("aaa|bbb|777|ccc".DeleteLine(-1, "|"), "aaa|bbb|777")
    }
    Test_ReadLine() {
        DUnit.Throws(_String.ReadLine.Bind("abc", 0, "a"), "ValueError")
